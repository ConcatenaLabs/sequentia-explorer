...
<style>
  ...
  <div class="grid">
    ...
    <a class="card" href="/dex/"><h2>SeqDEX →</h2><p>The decentralized exchange of the Sequentia testnet: pure Lightning swaps on the LNDEX, atomic on-chain and covenant orders, a confidential book, and a marketplace for Lightning channel liquidity. Trades are signed by the Sequentia browser extension wallet.</p></a>
    ...
    <a class="card" href="/lending/"><h2>Pignus Lending →</h2><p>Borrow USDX against GOLD, SILVR, OILX, tSEQ or native Bitcoin. The loan’s terms are compiled into a covenant the network enforces, so nobody holds your collateral, nobody can change the deal after you agree it, and repaying needs no one’s permission.</p></a>
    <a class="card" href="/levo/"><h2>Levo Launchpad →</h2><p>Back new projects on Sequentia, or raise for your own: staked Sequence sets how much you can put into a sale, and a covenant holds the project's tokens from the moment they are locked until they reach a buyer, paying the treasury in the same transaction.</p></a>
    ...
    <a class="card" href="/download/"><h2>Downloads →</h2><p>Full node and desktop wallet, plus Fulmen: a SeqLN Lightning node with a desktop GUI. For Linux and Windows. Ambra for Android, and the browser extension wallet for Chrome.</p></a>
  </div>
  <footer>
    <div class="by">
      <span>Built by</span>
