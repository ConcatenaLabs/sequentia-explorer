...
const CARD = {
  ...
  faucet: ['/faucet', 'Faucet', 'Free testnet coins: tSEQ and sample assets (USDX, EURX, GOLD, SILVR, OILX), sent straight to any address, from your full node or the Sequentia Core desktop wallet.'],
