...
<style>
  ...
  <div class="grid">
    ...
    <a class="card" href="/bridge/"><h2>Compages Bridge →</h2><p>Bridge into the Sequentia network from Ethereum (Sepolia: ether or any ERC-20), Bitcoin (testnet4: BTC to SBTC) and Solana (devnet: SOL to SOL.s); a deposit mints a Sequentia asset, a return releases the original.</p></a>
